...
if(!empty($_POST) && $_SERVER['REQUEST_METHOD'] == 'POST')
{
 ...
 $sql="INSERT INTO user(first_name,email,address,phone,dob,gender,password,city) VALUES('$firstname','$email','$address','$tel','$dob','$gen','$password','$city')";
...
/*
  $sql="INSERT INTO user(first_name,email,address,phone,dob,gender,password) VALUES(:firstname,:email,:address,:phone,:dob,:gender,:password)";
$query = $dbh->prepare($sql);
$query->bindParam(':firstname',$firstname,PDO::PARAM_STR);
$query->bindParam(':email',$email,PDO::PARAM_STR);
$query->bindParam(':address',$address,PDO::PARAM_STR);
$query->bindParam(':phone',$tel,PDO::PARAM_STR);
$query->bindParam(':dob',$dob,PDO::PARAM_STR);
$query->bindParam(':gender',$gen,PDO::PARAM_STR);
...
<?php if($msg){ ?><span style="color: green;"><?php echo $msg; ?></span><?php } else if($error){ ?> <span style="color: red;"><?php echo $error; ?></span> <?php } ?>
		<form id="registration_form"  method="post" onsubmit="event.preventDefault(); validation()"  method="post"><b><h2>Registration Form</h2></b>
            ...
            <input type="password" id="Pword" name="psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
  ...
  <p id="length" class="invalid">Minimum <b>8 characters</b></p>
			...
			<button class="submit" id="submitbtn" name="submitbtn" type="submit" desabled>Register</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
